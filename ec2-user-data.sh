...
aws s3 cp s3://westmichigansoftware/deployments/fremontmi-2.0.4.jar /home/ec2-user/fremontmi-2.0.4.jar
...
sudo bash -c 'nohup java -jar /home/ec2-user/fremontmi-2.0.4.jar > /var/log/app.log 2>&1 &'
